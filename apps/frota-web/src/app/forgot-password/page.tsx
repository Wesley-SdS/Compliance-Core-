    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-slate-900">FrotaLeve</h1>
        </div>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-8 shadow-sm">
          ...
          {sent ? (
            <div className="text-center py-4">
              ...
              <a href="/sign-in" className="mt-4 inline-block text-sm text-teal-600 hover:text-teal-700 font-medium">
                Voltar ao login
              </a>
            </div>
          ) : (
          ...
          <p className="mt-4 text-center text-xs text-slate-500">
            <a href="/sign-in" className="text-teal-600 hover:text-teal-700 font-medium">Voltar ao login</a>
          </p>
        </div>
      </div>
    </div>
