        ...
        <div className="bg-white rounded-xl border border-slate-200 p-8 shadow-sm">
          ...
          {sent ? (
            <div className="text-center py-4">
              ...
              <a href="/sign-in" className="mt-4 inline-block text-sm text-amber-600 hover:text-amber-700 font-medium">
                Voltar ao login
              </a>
            </div>
          ) : (
          ...
          <p className="mt-4 text-center text-xs text-slate-500">
            <a href="/sign-in" className="text-amber-600 hover:text-amber-700 font-medium">Voltar ao login</a>
          </p>
        </div>
      </div>
    </div>
