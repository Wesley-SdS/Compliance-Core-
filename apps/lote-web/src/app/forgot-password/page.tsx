    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-slate-900">LotePro</h1>
        </div>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-8 shadow-sm">
          ...
          {sent ? (
            <div className="text-center py-4">
              ...
              <a href="/sign-in" className="mt-4 inline-block text-sm text-orange-600 hover:text-orange-700 font-medium">
                Voltar ao login
              </a>
            </div>
          ) : (
            <form onSubmit={handleSubmit}>
              <div className="space-y-4">
                ...
                <button type="submit" disabled={loading}
                  className="w-full py-2.5 bg-orange-600 text-white text-sm font-medium rounded-lg hover:bg-orange-700 disabled:opacity-50 transition-colors">
          ...
          <p className="mt-4 text-center text-xs text-slate-500">
            <a href="/sign-in" className="text-orange-600 hover:text-orange-700 font-medium">Voltar ao login</a>
          </p>
        </div>
      </div>
    </div>
